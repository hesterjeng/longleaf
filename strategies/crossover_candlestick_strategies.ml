...
let golden_cross_candlestick =
  ...
  in
  {
    ...
    buy_trigger =
      ...
      (hammer_pattern >. Float 0.0
      ||. (piercing_pattern >. Float 0.0)
      ||. (engulfing_pattern >. Float 0.0))
      &&.
      (* RSI not overbought *)
      (rsi_14 <. Float 70.0)
      &&.
...
let macd_doji_reversal =
  ...
  let bb_lower = Data (Data.Type.Tacaml (Tacaml.Indicator.lower_bband ())) in
  {
    ...
    buy_trigger =
      ...
      (doji_pattern >. Float 0.0
      ||. (Gadt.dragonfly_doji >. Float 0.0)
      ||. (morning_star >. Float 0.0))
      &&.
...
let stochastic_three_soldiers =
  ...
  in
  {
    ...
    buy_trigger =
      ...
      (three_white_soldiers >. Float 0.0)
      &&.
    ...
    sell_trigger =
      (* Bearish patterns *)
      three_black_crows <. Float 0.0
      ||. (evening_star <. Float 0.0)
      ||.
...
let rsi_hanging_man =
  ...
  in
  {
    ...
    buy_trigger =
      ...
      (inverted_hammer >. Float 0.0 ||. (hammer >. Float 0.0))
      &&.
    ...
    sell_trigger =
      ...
      hanging_man <. Float 0.0
      ||. (shooting_star <. Float 0.0)
...
let williams_engulfing =
  ...
  in
  {
    ...
    buy_trigger =
      ...
      (bullish_engulfing >. Float 0.0 ||. (belt_hold >. Float 0.0))
      &&.
      (* Trend strength *)
      (adx_14 >. Float 20.0)
      &&.
...
let cci_star_patterns =
  ...
  in
  {
    ...
    buy_trigger =
      ...
      (morning_star >. Float 0.0 ||. (abandoned_baby >. Float 0.0))
      &&.
